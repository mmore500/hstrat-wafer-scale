...
\begin{subfigure}[c]{\linewidth}
 ...
 \caption{adaptive vs. purifying phylometric structure}
...
\begin{subfigure}[c]{0.5\linewidth}
 ...
 \caption{purifying regime}
  \label{fig:on-device-purifying}
\end{subfigure}

\caption{%
\textbf{On-hardware Trial.}
Results from phylogenetic reconstruction of 1 million generation simulations with 10k ($100\times100$), 25k ($500\times500$) and 56.25k ($750\times750$) PE arrays.
