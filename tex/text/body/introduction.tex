...
% The ULAM framework then ties into implementation-level infrastructure necessary to accomplish performant, best-effort lock/release of spatial event windows spanning bordering hardware unites \citep{ackley2013movable}.
...
% The very recent CS-3 chip announcement, which boosts clustering support to potentially thousands of constituent accelerators \citep{moore2024cerebras}.
