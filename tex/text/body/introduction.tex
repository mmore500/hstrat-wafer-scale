...
Exigently, scale lies core to key directions in artificial life research, like transitions in individuality, ecological dynamics, and rare evolutionary innovations \citep{CITETODO}.
...
Parallel and distributed computation, however, imposes compromises with respect to the convienence, flexibility, observability, interprability, and replicability enjoyed under centralized, serial models of computation. % incorporation, compromise
Here, we explore alignment of digital evolution to hardware at the extreme cutting-edge of massively-parallel, accelerator-driven computation and develop algorithms to mitigate limitations of distributed computation.
