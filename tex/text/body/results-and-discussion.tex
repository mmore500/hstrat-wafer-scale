...
%For assessment of  we refer the reader to related work CITE.
...
Trials measured the real time speed of sequential generation updates on one annotation with capacity for 64 differentia. % TODO check this
...
Ttrials with 1,600 PEs ($40\times40$) performed similarly, completing 17,734 generations per second.
...
% Extensive other work CITE has validated the underlying hereditary surface algorithm and the reconstruction algorithm.
...
% We look forward to future work expand the repetoire of  \citep{moreno2023toward}, which
