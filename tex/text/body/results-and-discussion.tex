...
Then, we validate the credibility of our end-to-end annotation-to-reconstruction pipeline by reviewing the clade structure from varying-duration emulated WSE evolutionary runs.
Finally, we benchmark phylogeny-tracked WSE genetic algorithm implementation.
