...
For these experiments, we tagged genomes with a 16 bit randomly-generated identifier at simulation startup, as shown in Figure \ref{fig:genome-layout}.
% These identifiers identified clades descending from each founding genome.
Using the hardware emulator, we instantiated populations over a $3\times3$ PE collective for durations 25, 50, 100, and 250 generation cycles under drift conditions.
